...
> = BaseProps<
	...
	Attr
>;
export declare function newCenterBox<
	StartWidget extends Gtk.Widget = Gtk.Widget,
	CenterWidget extends Gtk.Widget = Gtk.Widget,
	EndWidget extends Gtk.Widget = Gtk.Widget,
	Attr = unknown,
>(
	...props: ConstructorParameters<
		typeof CenterBox<StartWidget, CenterWidget, EndWidget, Attr>
	>
): CenterBox<StartWidget, CenterWidget, EndWidget, Attr>;
export interface CenterBox<StartWidget, CenterWidget, EndWidget, Attr>
	extends Widget<Attr> {}
