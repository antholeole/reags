...
type ModifierKey = {
	[K in keyof typeof Gdk.ModifierType as K extends `${infer M}_MASK`
		? M
		: never]: number;
};
type Cursor =
...
export interface Widget<Attr> extends Required<CommonProps<Attr>> {
	...
	>(key: Key, callback: Fn): this;
	keybind<
		Fn extends (self: this, event: Gdk.Event) => void,
		Key extends keyof Keys,
		Mod extends Array<keyof ModifierKey>,
	>(mods: Mod, key: Key, callback: Fn): this;
...
export declare class AgsWidget<Attr>
	extends Gtk.Widget
	implements Widget<Attr>
{
	...
	_init(
		config?: BaseProps<
			this,
			Gtk.Widget.ConstructorProperties & {
				child?: Gtk.Widget;
			},
			Attr
		>,
