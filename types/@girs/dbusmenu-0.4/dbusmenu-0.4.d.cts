...
export interface Client {
	...
	connect(
		sigName: "event-result",
		callback: Client.EventResultSignalCallback,
	): number;
	connect_after(
		sigName: "event-result",
		callback: Client.EventResultSignalCallback,
	...
	connect(
		sigName: "icon-theme-dirs-changed",
		callback: Client.IconThemeDirsChangedSignalCallback,
	): number;
	connect_after(
		sigName: "icon-theme-dirs-changed",
		callback: Client.IconThemeDirsChangedSignalCallback,
	...
	connect(
		sigName: "item-activate",
		callback: Client.ItemActivateSignalCallback,
	): number;
	connect_after(
		sigName: "item-activate",
		callback: Client.ItemActivateSignalCallback,
	...
	connect(
		sigName: "layout-updated",
		callback: Client.LayoutUpdatedSignalCallback,
	): number;
	connect_after(
		sigName: "layout-updated",
		callback: Client.LayoutUpdatedSignalCallback,
	...
	connect(
		sigName: "new-menuitem",
		callback: Client.NewMenuitemSignalCallback,
	): number;
	connect_after(
		sigName: "new-menuitem",
		callback: Client.NewMenuitemSignalCallback,
	...
	connect(
		sigName: "root-changed",
		callback: Client.RootChangedSignalCallback,
	): number;
	connect_after(
		sigName: "root-changed",
		callback: Client.RootChangedSignalCallback,
	...
	connect(
		sigName: "notify::dbus-name",
		callback: ($obj: Client, pspec: GObject.ParamSpec) => void,
	): number;
	connect_after(
		sigName: "notify::dbus-name",
		callback: ($obj: Client, pspec: GObject.ParamSpec) => void,
...
export interface Menuitem {
	...
	connect(
		sigName: "about-to-show",
		callback: Menuitem.AboutToShowSignalCallback,
	): number;
	connect_after(
		sigName: "about-to-show",
		callback: Menuitem.AboutToShowSignalCallback,
	...
	connect(
		sigName: "child-added",
		callback: Menuitem.ChildAddedSignalCallback,
	): number;
	connect_after(
		sigName: "child-added",
		callback: Menuitem.ChildAddedSignalCallback,
	...
	connect(
		sigName: "child-moved",
		callback: Menuitem.ChildMovedSignalCallback,
	): number;
	connect_after(
		sigName: "child-moved",
		callback: Menuitem.ChildMovedSignalCallback,
	...
	connect(
		sigName: "child-removed",
		callback: Menuitem.ChildRemovedSignalCallback,
	): number;
	connect_after(
		sigName: "child-removed",
		callback: Menuitem.ChildRemovedSignalCallback,
	...
	connect_after(
		sigName: "event",
		callback: Menuitem.EventSignalCallback,
	): number;
	emit(
		sigName: "event",
		arg1: string | null,
	...
	connect(
		...
		callback: Menuitem.ItemActivatedSignalCallback,
	): number;
	connect_after(
		sigName: "item-activated",
		callback: Menuitem.ItemActivatedSignalCallback,
	...
	connect(
		sigName: "property-changed",
		callback: Menuitem.PropertyChangedSignalCallback,
	): number;
	connect_after(
		sigName: "property-changed",
		callback: Menuitem.PropertyChangedSignalCallback,
	...
	connect(
		sigName: "realized",
		callback: Menuitem.RealizedSignalCallback,
	): number;
	connect_after(
		sigName: "realized",
		callback: Menuitem.RealizedSignalCallback,
	...
	connect(
		sigName: "show-to-user",
		callback: Menuitem.ShowToUserSignalCallback,
	): number;
	connect_after(
		sigName: "show-to-user",
		callback: Menuitem.ShowToUserSignalCallback,
...
export module MenuitemProxy {
	...
	export interface ConstructorProperties
		extends Menuitem.ConstructorProperties {
...
export interface MenuitemProxy {
	...
	connect(
		sigName: "notify::menu-item",
		callback: ($obj: MenuitemProxy, pspec: GObject.ParamSpec) => void,
	): number;
	connect_after(
		sigName: "notify::menu-item",
		callback: ($obj: MenuitemProxy, pspec: GObject.ParamSpec) => void,
...
export interface Server {
	...
	connect(
		sigName: "item-activation-requested",
		callback: Server.ItemActivationRequestedSignalCallback,
	): number;
	connect_after(
		sigName: "item-activation-requested",
		callback: Server.ItemActivationRequestedSignalCallback,
	...
	connect(
		sigName: "item-property-updated",
		callback: Server.ItemPropertyUpdatedSignalCallback,
	): number;
	connect_after(
		sigName: "item-property-updated",
		callback: Server.ItemPropertyUpdatedSignalCallback,
	...
	connect(
		sigName: "item-updated",
		callback: Server.ItemUpdatedSignalCallback,
	): number;
	connect_after(
		sigName: "item-updated",
		callback: Server.ItemUpdatedSignalCallback,
	...
	connect(
		sigName: "layout-updated",
		callback: Server.LayoutUpdatedSignalCallback,
	): number;
	connect_after(
		sigName: "layout-updated",
		callback: Server.LayoutUpdatedSignalCallback,
