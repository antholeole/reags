 ...
 */
export function font_set_variation(
	font: font_t,
	tag: tag_t,
	value: number,
): void;
 ...
 * @param font the font
 */
export function paint_color_glyph(
	funcs: paint_funcs_t,
	paint_data: any | null,
	glyph: codepoint_t,
	font: font_t,
 ...
 */
export function paint_funcs_set_color_glyph_func(
	funcs: paint_funcs_t,
 ...
 */
export function version_atleast(
	major: number,
	minor: number,
	micro: number,
): bool_t;
