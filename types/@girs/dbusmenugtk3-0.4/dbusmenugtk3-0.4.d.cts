 ...
 */
export function gtk_parse_get_cached_item(
	widget: Gtk.Widget,
): Dbusmenu.Menuitem;
/**
 ...
 */
export function menuitem_property_get_image(
 ...
 */
export function menuitem_property_get_shortcut(
	menuitem: Dbusmenu.Menuitem,
): [/* key */ number, /* modifier */ Gdk.ModifierType];
/**
 ...
 * @returns Whether it was successful at setting the property.
 */
export function menuitem_property_set_shortcut_menuitem(
	menuitem: Dbusmenu.Menuitem,
	gmi: Gtk.MenuItem,
): boolean;
/**
 ...
 * @returns Whether it was successful at setting the property.
 */
export function menuitem_property_set_shortcut_string(
	menuitem: Dbusmenu.Menuitem,
	shortcut: string,
): boolean;
export module Client {
	...
	export interface ConstructorProperties
		extends Dbusmenu.Client.ConstructorProperties {}
}
...
export interface Menu extends Atk.ImplementorIface, Gtk.Buildable {
	...
	connect(
		sigName: "notify::reserve-toggle-size",
		callback: ($obj: Menu, pspec: GObject.ParamSpec) => void,
	): number;
	connect_after(
		sigName: "notify::reserve-toggle-size",
